...
public class TimedSpawnerRandom: MonoBehaviour {
    ...
    IEnumerator SpawnRoutine() {    // co-routines
        while (true) {
            ...
            //My addition: made the enemies move also sideways 
            velocityOfSpawnedObject.x = 
                Random.Range(-XIntensity * velocityOfSpawnedObject.y, 
                XIntensity * velocityOfSpawnedObject.y);
